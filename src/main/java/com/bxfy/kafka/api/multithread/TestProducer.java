...
public class TestProducer {
    public static void main(String[] args) {
        ...
        properties.put(ProducerConfig.CLIENT_ID_CONFIG, "thread-producer");
...
//        properties.put(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG, CustomerProducerInterceptor.class.getName());
        ...
        for (int i = 0; i < 10; i++) {
            ...
            ProducerRecord<String, String> record = new ProducerRecord<String, String>(TOPIC_THREAD, JSON.toJSONString(user));
