package com.bxfy.kafka.api.consumer.rebalance;
...
import static com.bxfy.kafka.api.constant.Constant.TOPIC_REBALANCE;

/**
 * @Author Mengdexin
 * @date 2022 -05 -08 -20:24
 */
public class RebalanceTo1Consumer {
...
//        properties.put(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG, CustomerConsumerInterceptor.class.getName());
        ...
        consumer.subscribe(Collections.singletonList(TOPIC_REBALANCE), new ConsumerRebalanceListener() {
            @Override
            public void onPartitionsRevoked(Collection<TopicPartition> partitions) {
                System.out.println(String.format("Revoked is partitions : %s", partitions));
            }

            @Override
            public void onPartitionsAssigned(Collection<TopicPartition> partitions) {
                System.out.println(String.format("Assigned is partitions : %s", partitions));
            }
        });
