...
public class InterceptorConsumer {
    public static void main(String[] args) {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "interceptorstart-group");
        ...
        consumer.subscribe(Collections.singletonList(TOPIC_INTERCEPTOR));
        System.out.println("---interceptorstart consumer started ------");
        //进行获取消息内容
        try{
            while (true) {
                //拉取数据
